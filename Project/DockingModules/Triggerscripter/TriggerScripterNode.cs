...
namespace SMHEditor.DockingModules.Triggerscripter
{
    ...
    public class TriggerscripterSocket_Output : TriggerscripterSocket
    {
        public TriggerscripterSocket_Output(
            string name, string type, Color socketColor, TriggerscripterNode n, Rectangle r, bool showType, bool multiConnection, Type limitType)
    ...
    public class TriggerscripterNode_Trigger : TriggerscripterNode
    {
        ...
        {
            Foundry.propertyEditor.control.AddProperty(nameProperty);
            Foundry.propertyEditor.control.AddProperty(activeProperty);
            Foundry.propertyEditor.control.AddProperty(conditionalTypeProperty);
            Foundry.propertyEditor.control.AddProperty(conditionalTriggerProperty);
        }
    ...
    public class TriggerscripterNode_Variable: TriggerscripterNode
    {
        ...
        {
            Foundry.propertyEditor.control.AddProperty(nameProperty);
            Foundry.propertyEditor.control.AddProperty(valueProperty);
        }
        public override void Deselected()
        {
            Foundry.propertyEditor.control.Clear();
        }
    ...
    public class TriggerscripterNode_Condition : TriggerscripterNode
    {
        ...
        public override void Selected()
        {
            Foundry.propertyEditor.control.AddProperty(invertedProperty);
        }
        public override void Deselected()
        {
            Foundry.propertyEditor.control.Clear();
