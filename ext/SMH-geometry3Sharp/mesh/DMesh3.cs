...
namespace g3
{
    ...
    public partial class DMesh3 : IDeformableMesh
    {
        ...
        {
            vertices = new DVector<float>(copy.vertices);
        ...
        public void SetVertex(int vID, Vector3d vNewPos) {
			...
			int i = 3*vID;
			vertices[i] = (float)vNewPos.x; vertices[i+1] = (float)vNewPos.y; vertices[i+2] = (float)vNewPos.z;
        ...
        public int AppendVertex(ref NewVertexInfo info)
        {
			...
			int i = 3*vid;
            vertices.insert((float)info.v[2], i + 2);
            vertices.insert((float)info.v[1], i + 1);
            vertices.insert((float)info.v[0], i);
        ...
        public DVector<float> VerticesBuffer {
            get { return vertices; }
            set { vertices = value; }
        }
