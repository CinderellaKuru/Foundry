...
namespace ST.Library.UI.NodeEditor
{
    public class STNodeOption
    {
        ...
        private string _SubDataType;
        public string SubDataType
        {
            get => _SubDataType;
            internal set => _SubDataType = value;
        }
        ...
        public STNodeOption(string strText, Type dataType, string subDataType, bool bSingle)
        {
            if (dataType == null) throw new ArgumentNullException("指定的数据类型不能为空");
            this._DotSize = 10;
            m_hs_connected = new HashSet<STNodeOption>();
            this._DataType = dataType;
            this._SubDataType = subDataType;
            this._Text = strText;
            this._IsSingle = bSingle;
        }
        ...
        public virtual ConnectionStatus CanConnect(STNodeOption op) {
            ...
            if (this._SubDataType != op._SubDataType) return ConnectionStatus.ErrorType;
        ...
        /// </summary>
        /// <returns>If null, no owner exists, otherwise the collection is returned</returns>
        ...
        public List<STNodeOption> GetConnectedSockets()
        {
            if (this._DataType == null) return null;
            return m_hs_connected.ToList();
        }
        ...
        /// <summary>
        /// Post data to all Options connected to the current Option
        /// </summary>
