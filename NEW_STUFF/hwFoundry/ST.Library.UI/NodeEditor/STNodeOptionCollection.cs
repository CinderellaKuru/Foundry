...
namespace ST.Library.UI.NodeEditor
{
    public class STNodeOptionCollection : IList, ICollection, IEnumerable
    {
        ...
        public STNodeOption Add(string strText, Type dataType, string subDataType, bool bSingle)
        {
            int nIndex = this.Add(new STNodeOption(strText, dataType, subDataType, bSingle));
